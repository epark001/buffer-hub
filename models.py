...
class CsvimportUiucprofs(models.Model):
    ''' Autogenerated model file csvimportuiucprofs Wed Aug  5 11:15:51 2020 '''

    col_1 = models.CharField(blank=False, null=False)
    col_2 = models.IntegerField(blank=True, null=True, default=0)
    col_3 = models.CharField(blank=True, null=True)
    col_4 = models.CharField(max_length=10, blank=True, default='')
    col_5 = models.CharField(max_length=10, blank=True, default='')
    col_6 = models.CharField(blank=True, null=True)
    col_7 = models.IntegerField(blank=True, null=True, default=0)
    col_8 = models.IntegerField(blank=True, null=True, default=0)
    col_9 = models.CharField(max_length=7, blank=True, default='')
    col_10 = models.CharField(max_length=7, blank=True, default='')
    col_11 = models.CharField(max_length=9, blank=True, default='')
    col_12 = models.DecimalField(max_digits=4, decimal_places=2, blank=True, null=True, default=0)

    class Meta:
        managed = False
        db_table = u'"csvimport_uiucprofs"'
